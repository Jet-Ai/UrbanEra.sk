    ...
    <>
      ...
      <header id="top" className="site-header">
        ...
        <nav aria-label="Hlavná navigácia">
          <a href="#o-nas">O nás</a><a href="#zameranie">Naše zameranie</a><Link href="/portfolio">Portfólio</Link><a href="#kontakt">Kontakt</a>
        </nav>
        <Link className="header-link" href="/portfolio">Prezrieť projekty <ArrowUpRight size={18} /></Link>
      </header><LanguageSwitcher/>
      <main id="obsah">
        <section className="hero" aria-labelledby="hero-heading">
          <div className="hero-copy">
            <div className="eyebrow"><span className="little-line" /> NEHNUTEĽNOSTI · DEVELOPMENT · VÝSTAVBA</div>
            <h1 id="hero-heading">Nová éra<br />priestoru<span className="green-dot">.</span></h1>
        ...
        <section className="portfolio-feature"><div><div className="section-label"><span>03 /</span> PORTFÓLIO INTERIÉROV</div><h2>Veľké predstavy.<br />Premyslené detaily.</h2><p>Päť rezidenčných konceptov. Osemdesiat vizualizácií.<br />Objavte naše interiéry od prvého pohľadu po posledný detail.</p><Link className="text-link" href="/portfolio">Objaviť portfólio <ArrowUpRight size={20}/></Link></div><Link href="/portfolio" aria-label="Prezrieť portfólio interiérov"><Image unoptimized width={1200} height={900} src="https://drive.google.com/thumbnail?id=1eHfDIe2n3JgI8Jy8VEK5mZR8kJ2JGuaS&amp;sz=w1400" alt="UrbanEra — koncept vstupnej haly z portfólia Dom 01" loading="lazy" referrerPolicy="no-referrer"/></Link></section><section id="pristup" className="approach section-grid">
